sap.ui.define([
	...
	return Opa5.extend("ns.FioriPedidosHTML5Module.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ns/FioriPedidosHTML5Module/localService/mockserver"], function (mockserver) {

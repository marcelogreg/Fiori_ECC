sap.ui.define([
	"sap/ui/test/Opa5",
	"ns/FioriPedidosHTML5Module/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ns.FioriPedidosHTML5Module.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "ns.FioriPedidosHTML5Module",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "ListPurchaseOrderHeader/" + sObjectId;
